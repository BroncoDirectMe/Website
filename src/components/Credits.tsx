...
import SamanyuImage from './images/samanyu24x.png';
import TimothyImage from './images/t1mato.jpg';
import MatthewPImage from './images/tapatiohaxx.jpg';
